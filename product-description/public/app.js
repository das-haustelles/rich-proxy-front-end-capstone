...
*/
    ...
    /* 2 */
    /** */ function(module, exports, __webpack_require__) {
      const _reviews = __webpack_require__(3);
      ...
      const Reviews = (function(_React$Component) {
        ...
        function Reviews() {
          ...
          const _this = _possibleConstructorReturn(
            this,
            (Reviews.__proto__ || Object.getPrototypeOf(Reviews)).call(this)
          );
      ...
      /* WEBPACK VAR INJECTION */ (function(process) {
        ...
        if (process.env.NODE_ENV !== 'production') {
          (function() {
            ...
            const checkPropTypes = __webpack_require__(7);
            ...
            const REACT_SUSPENSE_TYPE = hasSymbol
              ...
              : 0xead1;
            const REACT_MEMO_TYPE = hasSymbol
              ? Symbol.for('react.memo')
              : 0xead3;
            const REACT_LAZY_TYPE = hasSymbol
                ...
                let fileName = path.replace(BEFORE_SLASH_RE, '');
                {
                  ...
                  if (/^index\./.test(fileName)) {
                    ...
                    if (match) {
                      ...
                      if (pathBeforeSlash) {
                        const folderName = pathBeforeSlash.replace(
                          BEFORE_SLASH_RE,
                          ''
                        );
              ...
              if (typeof type === 'object') {
                switch (type.$$typeof) {
                  ...
                  case REACT_LAZY_TYPE: {
                    const thenable = type;
                    const resolvedThenable = refineResolvedLazyComponent(
                      thenable
                    );
                    if (resolvedThenable) {
            ...
            function hasValidRef(config) {
              {
                if (hasOwnProperty.call(config, 'ref')) {
                  const getter = Object.getOwnPropertyDescriptor(config, 'ref')
                    .get;
            ...
            function hasValidKey(config) {
              {
                if (hasOwnProperty.call(config, 'key')) {
                  const getter = Object.getOwnPropertyDescriptor(config, 'key')
                    .get;
                  if (getter && getter.isReactWarning) {
                    return false;
                  }
            ...
            function escape(key) {
              ...
              const escapedString = `${key}`.replace(escapeRegex, function(
                match
              ) {
            ...
            function createElementWithValidation(type, props, children) {
              ...
              if (!validType) {
                ...
                if (type === null) {
                  ...
                  typeString = `<${getComponentName(type.type) ||
                    'Unknown'} />`;
                  info =
            ...
            function createFactoryWithValidation(type) {
              const validatedFactory = createElementWithValidation.bind(
                null,
                type
              );
            ...
            const react = React$3.default || React$3;
            ...
            for (const typeSpecName in typeSpecs) {
              if (has(typeSpecs, typeSpecName)) {
                ...
                if (error && !(error instanceof Error)) {
                  printWarning(
                    `${componentName ||
                      'React class'}: type specification of ${location} \`${typeSpecName}\` is invalid; the type checker ` +
